...
class BiodataController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $biodata->text=$request->get('text');
        $biodata->save();
        return redirect()->route('biodata.index')->with('success','Your 
    ...
    public function destroy($id)
    {
        $biodata = Biodata::find($id);
        $biodata->delete();
        return redirect()->route('biodata.index')->with('success','Your Data deleted successfully');
    }
}
